...
class CommunicationIdentityOperationsImpl {
     ...
     * @param options The options parameters.
     */
    exchangeTeamsUserAccessToken(token, appId, userId, options) {
     ...
     * @param options The options parameters.
     */
    issueAccessToken(id, scopes, options) {
 ...
 * Changes may cause incorrect behavior and will be lost if the code is regenerated.
 */
class IdentityRestClientContext extends coreClient__namespace.ServiceClient {
    /**
