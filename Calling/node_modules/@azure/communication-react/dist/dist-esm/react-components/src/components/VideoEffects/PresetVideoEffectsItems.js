...
const deriveProps = (props, fallbacks) => {
    ...
    const ariaLabel = ((_e = props.ariaLabel) !== null && _e !== void 0 ? _e : typeof ((_f = props.tooltipProps) === null || _f === void 0 ? void 0 : _f.content) === 'string') ? typeof ((_g = props.tooltipProps) === null || _g === void 0 ? void 0 : _g.content) : (_h = props.title) !== null && _h !== void 0 ? _h : fallbacks.ariaLabel;
